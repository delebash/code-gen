...
const localsName = _DEFAULT_LOCALS_NAME;
 ...
 * @return {String}
 */
const resolveInclude = function(name, filename, isDir) {
...
export const render = function (template, d, o) {
...
function Template(text, optsParam) {
  var opts = hasOwnOnlyObject(optsParam);
...
/**
 * Stringified version of constants used by {@link module:escapeXML}.
 *
...
try {
  ...
  // However, we can still explicitly shadow the prototype's "toString" property by defining a new "toString" property on this object.
    ...
    escapeXML.toString = escapeXMLToString;
  }
} catch (err) {
 ...
 * @private
 */
const hyphenToCamel = function (str) {
 ...
 * @private
 */
const hasOwnOnlyObject = function (obj) {
  var o = createNullProtoObjWherePossible();
  for (var p in obj) {
    if (hasOwn(obj, p)) {
      o[p] = obj[p];
    }
